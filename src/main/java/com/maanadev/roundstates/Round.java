...
public enum Round implements RoundstateOperations {
	...
	ROUNDINITIAL(new RoundInitial(), 0), ROUND_1(new RoundMiddle(), 1), ROUND_2(new RoundMiddle(), 2), ROUND_3(
			new RoundMiddle(), 3), ROUND_4(new RoundMiddle(), 4), ROUND_5(new RoundMiddle(), 5), ROUND_6(
	...
	public CARD getCardFromReq(PlayerCardChangeReq req) {
		// TODO Auto-generated method stub
		return operations.getCardFromReq(req);
	}

	public int getPlayerIdNum(String userid) {
		// TODO Auto-generated method stub
		return getPlayerIdNum(userid);
	}

	public Response handlePostRequest(PlayerCardChangeReq req) {
		// TODO Auto-generated method stub
		return operations.handlePostRequest(req);
	}
